...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.button_true = Button(image=self.true_image, pady=10, padx=10, highlightthickness=0)
        self.button_true.grid(column=0, row=2)

        self.false_image = PhotoImage(file='.\images\\false.png')
        self.button_false = Button(image=self.false_image, padx=10, pady=10, highlightthickness=0)
